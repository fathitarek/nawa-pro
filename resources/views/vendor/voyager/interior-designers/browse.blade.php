                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><input placeholder="Search by description"></td>
                                    <td><input placeholder="Search by website"></td>
...
@section('javascript')
    ...
    <script>
        ...
        var url="{{ route('interiorDesigners-datatable-index') }}";
        $('#dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: url,
            columns: [
                ...
                {data: 'photos',orderable: false, searchable: false, className: 'text-center'},
            ...
            initComplete: function () {
                this.api().columns().every(function () {
                    ...
                    input.setAttribute("placeholder","Search by Coloumn Name");
