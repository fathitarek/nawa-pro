            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        @endif
                        <form method="GET" style="right: 290px;position: absolute;" id="search-form" class="form-inline" role="form">

            <div class="form-group">
                <label for="name">Title</label>
                <input type="text" class="form-control" name="title" id="title" placeholder="search name">
            </div>
            <div class="form-group">
...
@section('javascript')
    ...
    <script>
        ...
        var url="{{ route('properties-datatable-index') }}";
        ...
        columns: [
            ...
            {data: 'price', name: 'properties.price'},
            {data: 'longtitude', name: 'properties.longtitude'},
            {data: 'latitiude', name: 'properties.latitiude'},
            {data: 'text_status', name: 'property_statuses.text'},
            {data: 'text_district', name: 'districts.text'},
