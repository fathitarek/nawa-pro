            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                            ...
                            method="POST" enctype="multipart/form-data" id='form1' onsubmit="return validateEmail();">
                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                @else
                                    <div class="form-group @if($row->type == 'hidden') hidden @endif @if(isset($display_options->width)){{ 'col-md-' . $display_options->width }}@else{{ '' }}@endif" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                        ...
                                        <input required="" type="email" data-name="email" id="email" class="form-control" name="email" placeholder="Email" id='email'  value="{{ $dataTypeContent->email or '' }}">
                                        @else
