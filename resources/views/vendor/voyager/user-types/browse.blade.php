                            ...
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tfoot style="width:100%">
                                        <tr>
                                            ...
                                            <td><input placeholder="Search by title"></td>
                                            <td><input placeholder="Search by limit property"></td>
...
@section('javascript')
    ...
    <script>
        ...
        var url="{{ route('userTypes-datatable-index') }}";
         $('#dataTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: url,
        columns: [
            ...
            {data: 'limit_property', name: 'limit_property'},
