            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                            ...
                            method="POST" enctype="multipart/form-data" onsubmit="return validateEmail();">
                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                @else
                                    <div class="form-group @if($row->type == 'hidden') hidden @endif @if(isset($display_options->width)){{ 'col-md-' . $display_options->width }}@else{{ '' }}@endif" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                        ...
                                        <input required="" type="email" id="email" data-name="Email" class="form-control" name="email" placeholder="Email" value="{{ $dataTypeContent->email or '' }}">
                                        @else
...
//    
      var email=$("#email").val();
       ...
       //window.alert(emailReg.test(email));
