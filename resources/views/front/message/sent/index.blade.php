    ...
    <div class="container-fluid">
        ...
        <div class="mailbox-header">
            <div class="mailbox-header-left">
                ...
                <div class="active-box" id="sent-mail">
                              ...
                              <a href="{{route('messages-sent-view', $mySubscriber->id)}}">
                                <div class="message-left">
                                  <span class=" big-checkbox">
                                              <input class="checkbox checkbox3 bulk-delete" id="checkItem" type="checkbox" value="{{$mySubscriber->id}}" />
                                  </span>
                                    <div class="message-list">
                                        <div>


                                        <span><img src="{{url('/storage/' .$mySubscriber->avatar)}}" alt="" /> </span>
